...
crudini --set $SAMBA_CONF home "comment" "Public Directories"
crudini --set $SAMBA_CONF home "path" "/usr/share/public"
crudini --set $SAMBA_CONF home "public" "yes"
crudini --set $SAMBA_CONF home "guest ok" "no"
crudini --set $SAMBA_CONF home "read only" "no"
crudini --set $SAMBA_CONF home "writeable" "yes"
crudini --set $SAMBA_CONF home "create mask" "0774"
crudini --set $SAMBA_CONF home "directory mask" "0774"
crudini --set $SAMBA_CONF home "browseable" "yes"
crudini --set $SAMBA_CONF home "printable" "no"
crudini --set $SAMBA_CONF home "oplocks" "yes"

crudini --set $SAMBA_CONF home "comment" "Private Directories"
crudini --set $SAMBA_CONF home "path" "/usr/share/private"
crudini --set $SAMBA_CONF home "public" "yes"
crudini --set $SAMBA_CONF home "guest ok" "no"
crudini --set $SAMBA_CONF home "read only" "no"
crudini --set $SAMBA_CONF home "writeable" "yes"
